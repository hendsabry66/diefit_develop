...
<div class="row">
    ...
    <div class="form-group col-md-6 mb-2">
        ...
        <select name="has_specialist" class="form-control">
    ...
    <div class="form-group col-md-6 mb-2">
        ...
        <select name="has_calories" class="form-control">
            <option value="1">@lang('admin.yes')</option>
            <option value="0">@lang('admin.no')</option>
        </select>
...
{{--    </div>--}}
    ...
    <div class="form-group col-md-6 mb-2">
        ...
        <select name="has_meals" class="form-control">
            <option value="1">@lang('admin.yes')</option>
            <option value="0">@lang('admin.no')</option>
        </select>
    </div>
...
{{--        value="{{ $subscription->meals }}" @endif>--}}
    ...
    <div class="form-group col-md-6 mb-2">
        <label for="projectinput4">@lang('admin.number_of_delivery_days')</label>
