                    ...
                    <div class="card-head">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="btn-group">
                                        <a href="{{ route('status.create') }}" class="btn btn-success">@lang('admin.addNewStatus') <i class="fa fa-plus"></i></a>
...
{{--                    <form action="{{ route('status.bulk-delete') }}" method="post" class="ajaxForm" id="bulk_delete_modal">--}}
{{--                        @csrf--}}
