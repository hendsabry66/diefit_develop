                            ...
                            <div class="d-md-flex">
                                ...
                                <div class="caption">
                                    ...
                                    <ul>
                                        ...
                                        <li>@lang('web.price'): <strong>{{$cart->price * $cart->quantity}}</strong></li>
                                    </ul>
                                </div>
                            </div>
    {{--                        <a href="{{url('restaurant/removeCart/'.$cart->id)}}"><i class="fa-solid fa-xmark"></i></a>--}}
            ...
            <form action="{{url('restaurant/save/order')}}"  method="post" class="form-checkout mt-5 clearfix">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="head">
