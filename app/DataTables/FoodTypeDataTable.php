...
class FoodTypeDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->escapeColumns([])
            ->addColumn('check', 'admin.foodTypes.datatables.check')
            ->editColumn('name', function ($q) {
                return "<a href='".route('foodTypes.show', $q->id)."'>".$q->getTranslations('name')['ar']."</a>";
            })
            ...
            ->addColumn('actions', 'admin.foodTypes.datatables.actions');
    }
     ...
     */
    public function query(FoodType $model)
    {
