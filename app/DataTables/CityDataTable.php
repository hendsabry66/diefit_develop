...
class CityDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ...
            ->editColumn('name', function ($q) {
                return "<a href='".route('cities.show', $q->id)."'>".$q->getTranslations('name')['ar']."</a>";
            })
            ->editColumn('area.name', function ($q) {
                return "<a href='".route('areas.show', $q->area_id)."'>".$q->area->getTranslations('name')['ar']."</a>";
            })
    ...
    {
        return $model->newQuery()->with('area')->select('cities.*');
    ...
    protected function getColumns()
    {
          ...
          return [
                ...
                ['name' => 'area.name', 'data' => 'area.name', 'title' => 'المنطقة'],
