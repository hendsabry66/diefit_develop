...
class ProductCategoryDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->escapeColumns([])
            ->addColumn('check', 'admin.product_categories.datatables.check')
            ->editColumn('name', function ($q) {
                return "<a href='".route('productCategories.show', $q->id)."'>".$q->getTranslations('name')['ar']."</a>";
            })
            ...
            ->addColumn('actions', 'admin.product_categories.datatables.actions');
    }
