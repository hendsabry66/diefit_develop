...
class ArticleDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->escapeColumns([])
            ->addColumn('check', 'admin.articles.datatables.check')
            ->editColumn('title', function ($q) {
                return "<a href='".route('articles.show', $q->id)."'>".$q->getTranslations('title')['ar']."</a>";
            })
            ->editColumn('short_description', function ($q) {
                return $q->getTranslations('short_description')['ar'];
            })
            ...
            ->addColumn('actions', 'admin.articles.datatables.actions');
    }
    ...
    {
        return $model->newQuery()->orderBy('id','desc')->with('articleCategory')->select('articles.*');;
    }
    ...
    protected function getColumns()
    {
        return [
            ...
            ['name' => 'title', 'data' => 'title', 'title' => 'العنوان'],
            ['name' => 'short_description', 'data' => 'short_description', 'title' => 'وصف مختصر'],
