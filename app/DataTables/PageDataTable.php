...
class PageDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->escapeColumns([])
            ->addColumn('check', 'admin.pages.datatables.check')
            ->editColumn('title', function ($q) {
                return "<a href='".route('pages.show', $q->id)."'>".$q->getTranslations('title')['ar']."</a>";
            })
            ...
            ->addColumn('actions', 'admin.pages.datatables.actions');
    ...
    protected function getColumns()
    {
        return [
            ...
            ['name' => 'title', 'data' => 'title', 'title' => 'الاسم'],
