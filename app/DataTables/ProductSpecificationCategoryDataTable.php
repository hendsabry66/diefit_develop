...
class ProductSpecificationCategoryDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->escapeColumns([])
            ->addColumn('check', 'admin.product_specification_categories.datatables.check')
            ->editColumn('name', function ($q) {
                return "<a href='".route('areas.show', $q->id)."'>".$q->getTranslations('name')['ar']."</a>";
            })
            ...
            ->addColumn('actions', 'admin.product_specification_categories.datatables.actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\ProductSpecificationCategory $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(ProductSpecificationCategory $model)
    {
...
//            ['name' => 'status', 'data' => 'status', 'title' => 'الحالة'],
    ...
    {
        return 'ProductSpecificationCategory_' . date('YmdHis');
    }
}
