...
class FoodCategoryDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->escapeColumns([])
            ->addColumn('check', 'admin.food_categories.datatables.check')
            ->editColumn('name', function ($q) {
                return "<a href='".route('foodCategories.show', $q->id)."'>".$q->getTranslations('name')['ar']."</a>";
            })
            ...
            ->addColumn('actions', 'admin.food_categories.datatables.actions');
    }
