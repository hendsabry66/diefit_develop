...
class DistrictsDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->escapeColumns([])
            ->addColumn('check', 'admin.districts.datatables.check')
            ->editColumn('name', function ($q) {
                return "<a href='".route('districts.show', $q->id)."'>".$q->getTranslations('name')['ar']."</a>";
            })
            ->editColumn('city.name', function ($q) {
                return "<a href='".route('cities.show', $q->city_id)."'>".$q->city->getTranslations('name')['ar']."</a>";
            })
            ...
            ->addColumn('actions', 'admin.districts.datatables.actions');
    }
    ...
    {
        return $model->newQuery()->with('city')->select('districts.*');
    }
    ...
    protected function getColumns()
    {
        return [
            ...
            ['name' => 'city.name', 'data' => 'city.name', 'title' => 'المدينه'],
