...
class ProductDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->escapeColumns([])
            ->addColumn('check', 'admin.products.datatables.check')
            ->editColumn('name', function ($q) {
                return "<a href='".route('products.show', $q->id)."'>".$q->getTranslations('name')['ar']."</a>";
            })
            ->rawColumns(['action'])
            ->addColumn('actions', 'admin.products.datatables.actions');
    }
