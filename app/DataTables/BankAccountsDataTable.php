...
class BankAccountsDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->escapeColumns([])
            ->addColumn('check', 'admin.bank_accounts.datatables.check')
            ...
            ->addColumn('actions', 'admin.bank_accounts.datatables.actions');
    }
     ...
     */
    public function query(BankAccounts $model)
    {
    ...
    protected function getColumns()
    {
        return [
            ...
            ['name' => 'account_iban', 'data' => 'account_iban', 'title' => 'الايبان'],
