...
class VideoDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->escapeColumns([])
            ->addColumn('check', 'admin.videos.datatables.check')
            ->editColumn('title', function ($q) {
                return "<a href='".route('videos.show', $q->id)."'>".$q->getTranslations('title')['ar']."</a>";
            })
            ...
            ->addColumn('actions', 'admin.videos.datatables.actions');
    }
    ...
    {
        return $model->newQuery()->with('videoCategory')->select('videos.*');;
